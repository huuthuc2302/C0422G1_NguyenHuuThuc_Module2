...
public class ReadFileCSV {
    ...
    public static void main(String[] args) {
        ...
        readFileCSV.writeFile(list, "src/ss16/bai_tap_2/file.csv", false);
        List<Country> countryList = readFileCSV.readFile("src/ss16/bai_tap_2/file.csv");
